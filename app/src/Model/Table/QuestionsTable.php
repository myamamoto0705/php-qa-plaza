...
class QuestionsTable extends Table
{
   ...
   * @param \Cake\Validation\Validator バリデーションインスタンス
   */
  public function validationDafault(Validator $validator)
  {
    $validator
    ...
    $validator
        ...
        ->maxLength('body', 140, '質問内容は140文字以内にしてください');
  ...
  {
    $rules->add($rules->existsIn(['question_id'],'Questions','質問がすでに削除されているため回答することができません。'));
