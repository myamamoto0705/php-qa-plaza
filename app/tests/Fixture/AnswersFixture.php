...
class AnswersFixture extends TestFixture
{
  ...
  public $fields = [
    ...
    'user_id' = ['type' => 'integer', 'lengeth' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
  ...
  public function init()
  {
    $this->records = [
      ...
      [
        ...
        'user_id' => 2,
        'body' => '私はLaravelが好きです。',
        'created' => '2018-12-01 14:30:00',
        'modified' => '2018-12-01 14:30:00'
      ]
    ];
    parent::init();
  }
